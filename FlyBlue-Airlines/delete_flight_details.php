...
<html>
	<head>
		<title>
			Details de suppression sur les horaires de vol.
		</title>
		<style>
			input {
	...
	<body>
		...
		<form action="delete_flight_details_form_handler.php" method="post">
			<h2>INSCRIRE L'HORAIRE DE VOL A SUPPRIMER</h2>
			<div>
			<?php
				if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<strong style='color:green; padding-left:20px;'>L'horaire de vol a ete supprime avec succes</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color:red; padding-left:20px;'>* N ° de vol non valide / date de depart, veuillez saisir a nouveau.</strong>
						<br>
						<br>";
				}
			?>
			<table cellpadding="5" style="padding-left: 20px;">
				<tr>
					<td class="fix_table">Entrer le numero de vol.</td>

...
<html>
	...
	<body>
		...
		<?php
			...
			//$pass_name=array();
			echo "<h2>AJOUTER INFOS SUR LES PASSAGERS</h2>";
			...
			while($count<=$no_of_pass)
			{
					...
					echo "<tr>";
					echo "<td class=\"fix_table_short\">Nom : </td>";
					echo "<td class=\"fix_table_short\">Age : </td>";
					echo "<td class=\"fix_table_short\">Genre : </td>";
					echo "<td class=\"fix_table_short\">Choix nourriture</td>";
					echo "<td class=\"fix_table_short\">Passager fidel ID (if applicable)</td>";
					echo "</tr>";
					echo "<tr>";
				...
				echo "<br><h2>ENTRER INFO DU VOYAGE</h2>";
				echo "<table cellpadding=\"5\">";
				echo "<tr>";
				echo "<td class=\"fix_table_short\">Vous voulez un espace reserver?</td>";
				echo "<td class=\"fix_table_short\">Vous voulez un un traitement particulier pour baggage?</td>";
				echo "<td class=\"fix_table_short\">Vous voulez acheter une assurance de voyage?</td>";
				echo "</tr>";
				echo "<tr>";

...
<html>
	...
	<body>
		...
		<form action="activate_jet_details_form_handler.php" method="post">
			<h2>ENTREZ LES COORDONNEES DE L'ACTIVATION DES AVIONS</h2>
			<div>
			<?php
				if(isset($_GET['msg']) && $_GET['msg']=='success')
				{
					echo "<strong style='color: green'>activation reussie avec success.</strong>
						<br>
						<br>";
				}
				else if(isset($_GET['msg']) && $_GET['msg']=='failed')
				{
					echo "<strong style='color:red'>*code avion invalide, svp essaye a nouveau.</strong>
						<br>
						<br>";
				}
			?>
			<table cellpadding="5" style="padding-left: 20px;">
				<tr>
					<td class="fix_table">Entrer le code de l'avion</td>
				</tr>
				<tr>
